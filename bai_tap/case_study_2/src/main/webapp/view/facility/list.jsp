...
<head>
    ...
    <style>
        body {
            background-image: url(https://mega.com.vn/media/news/2306_hinh-nen-4k34.jpg);height: 750px;
        }
        table {
            border: solid 3px;
        }
...
<body>
<div class="p-3">
    <h2 style="font-family: 'UTM Flamenco';font-size: 40px;color: white" class="text-center fw-bold">FACILITY LIST</h2>
    ...
    <table id="facilityTable" class="table table-light table-striped table-bordered">
        <thead>
        <tr style="background-color: #4043FF" class="text-center text-black">
            <th class="text-center"><i class="fa-solid"></i>#</th>
            <th>Name</th>
            <th>Area</th>
            <th>Cost</th>
