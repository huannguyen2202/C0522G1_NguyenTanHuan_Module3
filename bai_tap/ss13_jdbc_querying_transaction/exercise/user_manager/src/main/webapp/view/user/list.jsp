...
<div class="px-5">
    ...
    <p>
        <a href="/user?action=create">
            <button class="btn btn-primary btn-sm">+Thêm mới người dùng</button>
        </a>
    </p>
    <p>
        <a href="/user?action=sort">
            <button class="btn btn-secondary btn-sm">Sắp xếp theo tên</button>
        </a>
    </p>
        ...
        <c:forEach var="user" items="${users}">
            <tr>
                ...
                <td><a href="/user?action=view&id=${user.getId()}">
                    <button class="btn btn-info btn-sm">Thông tin chi tiết</button>
                </a></td>
            </tr>
        </c:forEach>
    </table>
